...
<script>
// Lucide 风格图标 path 集合 (viewBox 24x24, stroke-based)
const ICON_PATHS = {
  search: '<circle cx="11" cy="11" r="8"/><path d="m21 21-4.3-4.3"/>',
  cast: '<path d="M2 8V6a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H8"/><path d="M2 12a9 9 0 0 1 8 8"/><path d="M2 16a5 5 0 0 1 4 4"/><line x1="2" x2="2.01" y1="20" y2="20"/>',
  play: '<polygon points="6 3 20 12 6 21 6 3"/>',
  home: '<path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/>',
  'play-square': '<rect x="2" y="6" width="20" height="14" rx="2"/><polygon points="10 10 16 13 10 16 10 10"/>',
  ...
  'battery-full': '<rect x="2" y="7" width="18" height="10" rx="2"/><line x1="22" x2="22" y1="11" y2="13"/><line x1="5" x2="5" y1="10" y2="14"/><line x1="8" x2="8" y1="10" y2="14"/><line x1="11" x2="11" y1="10" y2="14"/><line x1="14" x2="14" y1="10" y2="14"/>',
  ...
  'clock-arrow-up': '<path d="M12 6v6l4 2"/><circle cx="12" cy="12" r="10"/>',
  ...
  minimize: '<polyline points="4 14 10 14 10 20"/><polyline points="20 10 14 10 14 4"/><line x1="14" x2="21" y1="10" y2="3"/><line x1="3" x2="10" y1="20" y2="14"/>',
  ...
  'list-video': '<rect x="2" y="6" width="20" height="12" rx="2"/><path d="m10 10 5 2-5 2z"/>',
  'database': '<ellipse cx="12" cy="5" rx="9" ry="3"/><path d="M3 5v14a9 3 0 0 0 18 0V5"/><path d="M3 12a9 3 0 0 0 18 0"/>',
  bookmark: '<path d="m19 21-7-4-7 4V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v16z"/>'
}

// 需要 fill 填充而非 stroke 描边的图标
const FILL_ICONS = ['play', 'star-filled', 'heart-filled', 'flame']
...
export default {
  ...
  computed: {
    iconStyle() {
      ...
      return { width: s, height: s, display: 'inline-block', verticalAlign: 'middle' }
    },
    dataUri() {
      const path = ICON_PATHS[this.name] || ''
      const isFill = FILL_ICONS.includes(this.name)
      const fillAttr = isFill ? `fill="${this.color}"` : `fill="none"`
      const strokeAttr = isFill ? '' : `stroke="${this.color}" stroke-width="${this.strokeWidth}" stroke-linecap="round" stroke-linejoin="round"`
      const svg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" ${fillAttr} ${strokeAttr}>${path}</svg>`
      // 使用 encodeURIComponent 编码，兼容 H5 / App / 小程序
